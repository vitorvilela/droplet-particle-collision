...
//This file implements momentum-conserving VOF advection of the velocity components for the three-phase Navier–Stokes solver.
...
//We will transport the two components of the momentum, 
...
//We recover the advected velocity field using the total momentum and the density
  ...
  boundary ((scalar *){u});
//We set the list of interfaces to NULL so that the default vof() event does nothing (otherwise we would transport 
//f
// twice).
