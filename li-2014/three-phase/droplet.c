 ...
 * Qiuxiang Li, 2014.
 * 
 * Objective: - A numerical study on the deformation and breakup behavior of liquid droplet 
 * 		past a solid circular cylinder.
 * Methods/Models: - An improved interparticle-potential lattice Boltzmann method.
 * Analyses: - The effects of the eccentric ratio β, 
 * 	       viscosity ratio λ between the droplet and the surrounding fluid, 
 *             surface wettability, 
 *             and Bond number (Bo) 
 * 	       on the dynamic behavior of the liquid droplet are considered
 *  
 */
