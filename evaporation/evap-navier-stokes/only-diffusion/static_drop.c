/* Compile with:
 * 
 * 3D with MPI and graphics: CC99='mpicc -std=c99' qcc -Wall -O2 -grid=octree -D_MPI=1 static_drop.c -o static_drop -lm -L$BASILISK/gl -lglutils -lfb_glx -lGLU -lGLEW -lGL -lX11
 *      
