/* 
 * This Basilisk setup is intended to simulate the high-pressure droplet evaporation described in:
 * 
 * Twenty-Sixth Symposium (International) on Combustion/The Combustion Institute, 1996/pp. 1267–1273
 * EXPERIMENTAL STUDY ON HIGH-PRESSURE DROPLET EVAPORATION USING MICROGRAVITY CONDITIONS
 * HIROSHI NOMURA, YASUSHIGE UJIIE, HANS J. RATH, JUN’ICHI SATO, MICHIKATA KONO
 * 
 * Objective:
 *    - Evaporation of an individual fuel droplet at high pressures and high temperatures has been studied experimentally under microgravity conditions.
 *    - A suspended n-heptane droplet was used in the experiments at pressures in the range of 0.1–5.0 MPa and temperatures varying from 400 to 800 K.
 *    - Microgravity were employed to prevent natural convection that complicates the phenomena.
 *  
 * Analyses: 
 *    - Temporal variations of the droplet diameter.
 *    - The ratio of the initial heat-up time to the evaporation lifetime was used as a measure of unsteadiness of droplet evaporation. 
 *    
 * Validation:
 *    - No validation.
 *  
 * Outcomes: 
 *    - Dense fuel vapor surrounded a droplet and the droplet surface became obscure at high pressures and high temperatures.
 *    - Corrected evaporation lifetime te decreases mono- tonically as ambient temperature is increased.
 * 
 */
...
// Temperature
// @paper: temperatures varying from 400 to 800 K
